...
function Home() {
  ...
  <Row>
    ...
    My name is Ariana Winters and I'm from Salt Lake City,Utah. Growing up in Utah I came to love hiking and
            ...
            <hr/>
          I'm currently a Junior Software Engineer that is focused on front end. Most notably I've collaborated with my team to develop a centralized UI component library using React.JS, HTML5, CSS3, and JavaScript and migrated all Sass styles. Additionally I'm a passionate lifelong learner and have taken on the task of learning additional skills such as Python, Typescript, and Docker so that I have a better understanding of our software as a whole. 
            <hr/>
    </Col>
  </Row>
</Container>
